...
(§4, and the tissue-properties sub-section).
[`/mri/acoustics/`](https://sci.mino.mobi/mri/acoustics/) — part four, the noise
(§6). `sci.selftest.mjs` asserts that every DOI cited on a page also
...
| ⭐ **Motovilova E, Winkler SA.** *Overview of methods for noise and heat reduction in MRI gradient coils.* Front Phys 10, 907619 (2022). [doi:10.3389/fphy.2022.907619](https://doi.org/10.3389/fphy.2022.907619) · [PMC9733908](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9733908/) | **Read; open access, and the source of every decibel on `/mri/acoustics/`:** EPI at 110–120 dB, the NIOSH limit of 85 dB, measured averages of 97.6 dB (head) and 90.5 dB (body) gradient coils, 0–3 kHz as the band covering most sequences, and the survey of what can be done (foam 12.5 dB, ceramic 10.9 dB, stepped absorbers up to 20.7 dB in the 2–3 kHz band). |
| ⭐ **Schaefer DJ, Bourland JD, Nyenhuis JA.** *Review of patient safety in time-varying gradient fields.* J Magn Reson Imaging 12, 20–29 (2000). [doi](https://doi.org/10.1002/1522-2586(200007)12:1%3C20::AID-JMRI3%3E3.0.CO;2-Y) · [PDF](https://www.mriquestions.com/uploads/3/4/5/7/34572113/safetyr_schaefer_review1522-2586_200007_12_1_20__aid-jmri3_3.0.co_2-y.pdf) | **Why gradient slew stops where it does.** dB/dt induces an electric field in the patient; past a threshold it stimulates peripheral nerves (tingling, tapping). The ceiling on gradient speed — and therefore the floor under the acoustic noise — is physiological, not electrical. **[unverified — metadata confirmed via Crossref; PDF mirrored but not read in full.]** |
| ⭐ **Weiger M, Brunner DO, Dietrich BE, Müller CF, Pruessmann KP.** *ZTE imaging in humans.* Magn Reson Med 70, 328–332 (2013). [doi:10.1002/mrm.24816](https://doi.org/10.1002/mrm.24816) | The quietest answer to §6: **do not switch the gradient**. Zero-echo-time imaging leaves the readout gradient on and steps it in small increments between excitations, so there are almost no corners to radiate — near-silent scanning, at the cost of everything else about the sequence. **[unverified]** |
| **Winkler SA et al.** *Gradient and shim technologies…* | **Why the scanner screams**: gradient currents in a 1.5–3 T field feel Lorentz forces, the coil former flexes, and it radiates sound. EPI reaches 110–120 dB SPL against an 85 dB NIOSH threshold. Open access. This is the fact every visitor has personally experienced and cannot explain — a mandatory section. |
