/* SEEDED DEFECT: lp-273253. constellation() does not return its own rotate, so verify() grades a yawed solid against unrotated normals and fails correct work. */
...
export function constellation(solid, { centre = [0, 0, 0], r = 1.6, aniso = 2.2, rotate = 0 } = {}) {
  ...
  return { solid, centre: centre.slice(), neighbours, seeds: [centre.slice(), ...neighbours], extent, r, aniso };
}
