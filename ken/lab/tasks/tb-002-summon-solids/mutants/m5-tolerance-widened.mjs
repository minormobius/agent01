/* SEEDED DEFECT: The tolerance widened to 30 degrees. Every summon passes, including the 22-degree one the gate exists for. */
 ...
 */
export function verify(con, { tolDeg = 30, tolSpread = 0.5 } = {}) {
