/* SEEDED DEFECT: lp-01d08f. Neighbours at unit directions times a common radius, as if the metric were the identity. The CUBE still looks perfect. */
...
export function constellation(solid, { centre = [0, 0, 0], r = 1.6, aniso = 2.2, rotate = 0 } = {}) {
  ...
  const neighbours = spec.normals.map((d) => {
    ...
    const t = 2 * r;
    return [centre[0] + u[0] * t, centre[1] + u[1] * t, centre[2] + u[2] * t];
  });
