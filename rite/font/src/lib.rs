...
fn genome_json(p: &Params) -> String {
    format!(
        "{{\"family\":\"{}\",\"stem\":{:.0},\"thin\":{:.0},\"mod\":{:.2},\"contrast\":{:.2},\"width\":{:.2},\"slant\":{:.1},\"pen\":{:.0},\"aperture\":{:.2},\"arch\":{:.2},\"bar\":{:.2},\"bowl\":{:.0},\"xh\":{:.2},\"over\":{:.3},\"asc\":{:.2},\"desc\":{:.2},\"serif\":{},\"apex\":{},\"a2\":{},\"g2\":{},\"ball\":{},\"seriflen\":{:.0},\"serifth\":{:.0},\"weightClass\":{},\"widthClass\":{}}}",
        p.family,
        p.stem,
        pen::nib_thin(p),
        p.morph.modulation,
