/* @ts-self-types="./kite_solver.d.ts" */
 ...
 * @returns {string}
 */
export function solve_json(req) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.solve_json(retptr, ptr0, len0);
 ...
 * @returns {string}
 */
export function solver_info() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.solver_info(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kite_solver_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
