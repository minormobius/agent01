...
//   node hoop/v102/test/solvable.selftest.mjs
//
// Two halves:
...
// ── 2c. DIALOGUE REACHABILITY (v102): a set_facts parked where play can't reach is NOT a setter ──
...
// ── 2d. waivableGates (v102): the runtime waiver's shopping list ──
