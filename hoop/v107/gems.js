...
//
// v105 unified language: each of the seven crystal SYSTEMS carries one of the seven PLANETS, so a gem
...
// ── SYSTEM → PLANET (the v105 register bridge). A clean 7↔7 bijection: the lattice's combat character
...
export function gemBonus(gem, body) {
  ...
  // v105 body resonance: a socketed stone hardens the attribute your body already leans on.
