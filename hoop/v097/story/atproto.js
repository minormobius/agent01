// hoop/v096/story/atproto.js — the ATProto-native bridge for the story layer.
//
// VENDORED: a verbatim copy of hoop/story/atproto.js (re-sync, never fork). v096's story/ is a
// self-contained client copy, so the save lane (index.html: loadOwnSave/putSave/SAVE_NSID) imports it
// from here, not from the worker-side ../story/. It is pure (zero imports) — the client is injected.
//
