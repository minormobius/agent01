...
//
// v105 (the Factor Solen bug): an anchor like Solen spans the "wards" zone — its gates name keepers in the
...
//
// v105 (FUNGIBLE): `setters` may be the first-only map (gateSetters) OR the multi map (gateSettersMulti). The
