...
const FACTION_BY_ROLE = {   // map an econ/role tag onto a Tabard faction so the profile carries faction weight
  mend: 'continuant', make: 'continuant', govern: 'continuant', serve: 'continuant',
  trade: 'drift', broker: 'drift', play: 'drift',
