...
# Owning branch: see deploy-registry.json surface "hoop".
#
...
echo "  The current version is mirrored at https://hoop.mino.mobi/ (archived versions: hoop-archive.mino.mobi)."
