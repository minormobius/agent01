// voronoi.js — VERBATIM VENDORED COPY of hoop/paint/voronoi.js (the foam-cell painter behind
// hoop /paint/ + v3). Re-sync from source, never fork (same rule as hoop's vendor/auth.js): the
// fixture chamber must paint the SAME cells hoop v3 does, so a furnished chamber here matches the
// real game in situ. Only this banner is added; the kernel below is unchanged.
//
