...
import { namesAPerson } from './promote.js';   // v103: person-vs-room discrimination for the marker
...
export function questMarker(quest, npcNames) {
  ...
  // v103 npc reform: a ref that NAMES A PERSON who isn't placed yet is a PERSON marker, not a room. It used
