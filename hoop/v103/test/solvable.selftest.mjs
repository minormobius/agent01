...
//   node hoop/v103/test/solvable.selftest.mjs
//
// Two halves:
...
// ── 2c. DIALOGUE REACHABILITY (v103): a set_facts parked where play can't reach is NOT a setter ──
...
// ── 2d. waivableGates (v103): the runtime waiver's shopping list ──
