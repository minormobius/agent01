...
import { FOOD_CATEGORIES, FOOD_POOL } from "../pools/yum-pool.js";
import { RARITY_LABELS } from "../core/shared.js";
...
async function loadData() {
  ...
  try {
    const [jr, br, wr, cr] = await Promise.all([
      fetch("../data/embeddings/yum-embeddings.json"),
      fetch("../data/embeddings/yum-embeddings.bin"),
      fetch("../data/food/yum-wikipedia.json"),
      fetch("../data/food/yum-complementarity.json"),
    ]);
