...
| `photo` | frontend | `photo` | [photo.mino.mobi](https://photo.mino.mobi) | `claude/image-manipulation-platform-g5puxy` | [`photo/CLAUDE.md`](../photo/CLAUDE.md) | Photo explorer. Every image from any handle, rendered as a filterable masonry grid with engagement analytics. |
