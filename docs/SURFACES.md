...
| `hoop` | frontend | `hoop` | [hoop.mino.mobi](https://hoop.mino.mobi) | `claude/hoop-v107-quest-fixes-z2v3el` | [`hoop/CLAUDE.md`](../hoop/CLAUDE.md) | The GAME wing of the O’Neill cylinder pack: “the infinite game” — a deterministic glyph-world adventure over an endless ship engine, every place and save an ATProto record… |
| `hoop-archive` | frontend | `hoop-archive` | [hoop-archive.mino.mobi](https://hoop-archive.mino.mobi) | `claude/hoop-surface-cleanup-8ej3kd` | [`hoop-archive/CLAUDE.md`](../hoop-archive/CLAUDE.md) | The hoop museum: the original first-pass @-room forum game at /, the early engine passes v2–v8, and every frozen version snapshot v090–v107, each still independently served — with frozen same-origin c… |
