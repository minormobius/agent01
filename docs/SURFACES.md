...
| `cat` | fullstack | `cat` | [cat.mino.mobi](https://cat.mino.mobi) | `claude/cat-deploy-cleanup-n9cay6` | [`cat/CLAUDE.md`](../cat/CLAUDE.md) | Cats from the firehose. A live stream of cat photos posted to Bluesky, filtered by hashtag and image. |
