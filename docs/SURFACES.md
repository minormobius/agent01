...
| `foam` | frontend | `foam` | [foam.mino.mobi](https://foam.mino.mobi) | `claude/voronoi-foam-interactive-keo0uy` | [`foam/CLAUDE.md`](../foam/CLAUDE.md) | First person inside the rind’s voronoi foam. Shatter and re-weave the membranes with the shiva tools — up close — and climb to the beacon chamber, walking only: no jumps, max grade 35&deg;… |
