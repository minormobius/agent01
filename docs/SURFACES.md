...
| `fifty` | fullstack | `fifty` | [fifty.mino.mobi](https://fifty.mino.mobi) | `claude/fifty-microsites-deploy-fyjk1q` | [`fifty/CLAUDE.md`](../fifty/CLAUDE.md) | Fifty ATProto app pitches, one deploy surface: a landing index at / and one page per concept at /c/<n>. Thirty are working tools… |
...
| `hoop-archive` | frontend | `hoop-archive` | [hoop-archive.mino.mobi](https://hoop-archive.mino.mobi) | `claude/hoop-surface-cleanup-8ej3kd` | [`hoop-archive/CLAUDE.md`](../hoop-archive/CLAUDE.md) | The hoop museum: the original first-pass @-room forum game at /, the early engine passes v2–v8, and every frozen version snapshot v090–v108, each still independently served — with frozen same-origin c… |
