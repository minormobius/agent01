...
| `b` | frontend | `b` | [b.mino.mobi](https://b.mino.mobi) | `claude/ai-detection-browser-aw7kq5` | [`b/CLAUDE.md`](../b/CLAUDE.md) | Portal to every Bluesky tool here—feeds, network maps, account analysis, and the shared OAuth worker in one place. |
...
| `fluoddity` | frontend | `fluoddity` | [fluoddity.mino.mobi](https://fluoddity.mino.mobi) | `claude/fluoddity-param-space-viz-9d5g4b` | [`fluoddity/CLAUDE.md`](../fluoddity/CLAUDE.md) | Breed and fork emergent vector-trail organisms as deterministic genomes saved to your PDS, with an interactive phylogeny. |
...
| `jurassic` | frontend | `jurassic` | [jurassic.mino.mobi](https://jurassic.mino.mobi) | `claude/jurassic-forest-sounds-iym7ya` | [`jurassic/CLAUDE.md`](../jurassic/CLAUDE.md) | The Daohugou soundscape, walkable — a companion to Gu et al. 2026 (PNAS 123:e2615107123, open access), whose nine fossil ensiferans it plays… |
...
| `math` | frontend | `geometry` | [math.mino.mobi](https://math.mino.mobi) | `claude/holder-continuous-procgen-arqnj4` | [`geometry/CLAUDE.md`](../geometry/CLAUDE.md) | Hub for the extremal-geometry pack. Family-resemblance table sortable by era, technique, status — and an explicit roadmap of next entries (szemerédi–trotter, heilbronn, borsuk, viazovska, ...)… |
