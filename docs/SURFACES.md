...
| `cron` | backend | `workers/cron` | `minomobi-cron` | `claude/minomobi-landing-page-vg37b8` | [`workers/cron/CLAUDE.md`](../workers/cron/CLAUDE.md) | The cron trampoline… |
...
| `root` | frontend | `.` | [minomobi.com / mino.mobi (landing)](https://minomobi.com) | `claude/minomobi-landing-page-vg37b8` | [`CLAUDE.md`](../CLAUDE.md) | Thread analysis. Tidy-tree canvas view of any Bluesky conversation with contributor weighting and YAML export for LLMs. |
