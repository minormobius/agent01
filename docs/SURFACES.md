...
[`deploy-registry.json`](../deploy-registry.json). **76 surfaces.**
...
| `lab` | frontend | `lab/www` | [minomobi.com](https://minomobi.com) | `claude/lab-www` | [`lab/www/CLAUDE.md`](../lab/www/CLAUDE.md) | The lab factory. Tag the Bluesky service account and an agent builds you a site at minomobi.com/<name>/, permanently. (full description: lab/www/CLAUDE.md) |
...
| `root` | frontend | `.` | [mino.mobi (landing)](https://mino.mobi) | `claude/root-deploy-spec-doc-f3ucht` | [`CLAUDE.md`](../CLAUDE.md) | Thread analysis. Tidy-tree canvas view of any Bluesky conversation with contributor weighting and YAML export for LLMs. |
