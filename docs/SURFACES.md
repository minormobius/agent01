...
| `root` | frontend | `.` | [minomobi.com / mino.mobi (landing)](https://minomobi.com) | `claude/root-directory-audit-0tk7r7` | [`CLAUDE.md`](../CLAUDE.md) | Thread analysis. Tidy-tree canvas view of any Bluesky conversation with contributor weighting and YAML export for LLMs. |
