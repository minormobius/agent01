...
| `tjs` | frontend | `tjs` | [tjs.mino.mobi](https://tjs.mino.mobi) | `claude/threejs-procgen-buildings-mprgs6` | [`tjs/CLAUDE.md`](../tjs/CLAUDE.md) | tjs.mino.mobi — three.js workbenches… (full description: tjs/CLAUDE.md) |
...
| `unit` | frontend | `unit` | [unit.mino.mobi](https://unit.mino.mobi) | `claude/wavelength-color-calc-nsew9x` | [`unit/CLAUDE.md`](../unit/CLAUDE.md) | The unit converter (reference wing, sibling to moji + uni). Thin assets Worker (worker `unit`, custom_domain unit.mino.mobi) - no build/D1/AI/secrets… (full description: unit/CLAUDE.md) |
...
| `words` | fullstack | `words` | [words.mino.mobi](https://words.mino.mobi) | `claude/procedural-crossword-generation-p8hv2q` | [`words/CLAUDE.md`](../words/CLAUDE.md) | Words with friends, without the ads or the accounts. One to four seats, any of them a deterministic bot that reads a 168,551-word lexicon through a DAWG… |
