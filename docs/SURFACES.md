...
| `foam` | frontend | `foam` | [foam.mino.mobi](https://foam.mino.mobi) | `claude/foam-dungeon-generator-aoaz0j` | [`foam/CLAUDE.md`](../foam/CLAUDE.md) | First person inside the rind’s voronoi foam… |
