...
| `torus` | frontend | `clock` | [torus.mino.mobi](https://torus.mino.mobi) | `claude/fractal-torus-webgpu-97gxv4` | [`clock/CLAUDE.md`](../clock/CLAUDE.md) | Explorable 3D landscape with first-person controls. Local and networked multiplayer. |
