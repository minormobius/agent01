...
export function Sidebar({
    ...
    return (
      <div className={`wave-sidebar ${open ? 'open' : ''}`}>
        ...
        <div className="wave-note-list">
          {orgs.length === 0 ? (
            <div className="wave-note-empty">No organizations yet</div>
          ) : (
            orgs.map(o => (
  ...
  // Org selected — show channels, threads, members
