...
(function () {
  ...
  var TELLERS = [
    ...
    },
    {
      ...
      voice: {
        openers: ["the Sun being lord of the seven lamps, and I its keeper", "and the crown in this one was no idle gold", "and the fusion-heart burned high while I told it", "in the golden manner, then, as is fitting"],
