...
(function () {
  ...
  var PROPP = [
    ...
    { id: "reaction", sym: "E", name: "Hero's reaction", act: "journey", gloss: "The hero responds to the donor.",
      realize: ["%connect% %hero% answered as one ought — spared the small beast, shared the last bread, kept the hard word — and so passed.", "%connect% the hero did the kind thing without weighing it, which is the only way the test is ever passed.", "%connect% %hero% gave up the last of the bread to %donor% and went hungry, and that hunger bought the gift."] },
    ...
    { id: "guidance", sym: "G", name: "Guidance", act: "journey", gloss: "The hero is led to the object of the search.",
      realize: ["%connect% %helper% brought the hero the long way to %place2%, where the trouble kept its house.", "%connect% the road folded, the way roads fold in tales, and %hero% stood at the threshold of %place2% before the hero was ready.", "%connect% a thread, a thrown ball of yarn, a bird going on ahead — by such a guide %hero% came to %place2%."] },
    ...
    { id: "punishment", sym: "U", name: "Punishment", act: "recognition", gloss: "The villain is punished.",
      realize: ["%connect% %villain% paid — by the law, by the blade, or by the long shame, as the tale's country preferred.", "%connect% the wrong-doer got the wage of the wrong, and the hall was glad of it.", "%connect% %villain% was given exactly what %villain% had meant for another, which is the oldest justice and the most satisfying."],
  ...
  var FILL = {
    ...
    motifLead: ["And they tell, too:", "It is said, also:", "And mark this:", "Men say:", "And in that country, this —", "And — for the tale keeps such things —", "Now here is a thing the old reels hold:", "And it was ever so:", "And folk add:"]
  };
