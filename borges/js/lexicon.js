...
(function () {
  ...
  var PROPP = [
    { id: "first-function", sym: "α", name: "Initial situation", act: "setup", gloss: "The family and the hero are introduced.",
      realize: ["In %place% there dwelt %hero%, %heroEp%, and the days were good while they lasted.", "There was once in %place% a %honorific% whose heir was %hero%, and that is where it starts."] },
    { id: "absentation", sym: "β", name: "Absentation", act: "setup", gloss: "A member of the family is taken or goes away.",
      realize: ["%connect% %heroine% was taken in the dark — gone from the cradle, gone from the gate, and no agent named.", "%connect% %elder% went over the water and left the hall unwarded, and that was the door the trouble came in by."],
      invert: ["%connect% it was the villain who vanished first, sulking, and the whole hall had to go and coax him back — which is no way to start a tale, and exactly how this one starts."] },
    { id: "interdiction", sym: "γ", name: "Interdiction", act: "setup", gloss: "A prohibition is laid on the hero.",
      realize: ["%connect% the word was laid on %hero%: by no means open %object%, by no means cross into %place%.", "%connect% %elder% forbade the one thing — touch not %object%, ask not the name — as elders will."] },
    { id: "violation", sym: "δ", name: "Violation", act: "setup", gloss: "The prohibition is broken.",
      realize: ["%connect% the word was broken, as words in tales are broken, and %object% was opened.", "%connect% %hero% did the forbidden thing within the hour, for what is a prohibition but a signpost."],
      invert: ["%connect% %hero% kept the prohibition faithfully, to the letter, for ever, and so nothing happened at all — until the teller lost patience and broke it for them."] },
    { id: "reconnaissance", sym: "ε", name: "Reconnaissance", act: "complication", gloss: "The villain makes an attempt at reconnaissance.",
      realize: ["%connect% %villain% went abroad to learn the lie of the land, asking after %object% and after the hero's name.", "%connect% %villain% sent out scouts, or was the scout, sniffing for the weak place in the wall."] },
    { id: "trickery", sym: "η", name: "Trickery", act: "complication", gloss: "The villain deceives, to take possession.",
      realize: ["%connect% %villain% came in fair clothing to %place% and asked a boon before he would name it — the oldest snare there is.", "%connect% %villain% put on a kind face and offered %hero% a bargain that had a hook in the soft of it."] },
    { id: "complicity", sym: "θ", name: "Complicity", act: "complication", gloss: "The victim submits and unwittingly helps.",
      realize: ["%connect% %hero% granted it before the naming — whatever you ask, you shall have — and so gave away %object% and the half of %place% with it.", "%connect% the hero believed the fair face, and helped the trap shut on the hero's own hand."] },
    { id: "villainy", sym: "A", name: "Villainy / Lack", act: "complication", gloss: "The villain causes harm, or a lack is felt.",
      realize: ["%connect% the harm was done: %heroine% carried off to %place%, and the hall sat in the ash of it.", "%connect% there opened in the kingdom a lack — no heir, no water, no %object% — and a lack is a hunger that walks."],
      invert: ["%connect% the villain did the harm and then felt so badly about it that he wrote a letter of apology, which is not in Propp, and which is exactly what happened."] },
    { id: "mediation", sym: "B", name: "Mediation", act: "complication", gloss: "The lack is made known; the hero is dispatched.",
      realize: ["%connect% the word came to %hero% by %dispatcher%, and the hero rose: this wrong is mine to mend.", "%connect% %dispatcher% laid the lack before the hall, and every eye turned to %hero%."] },
    { id: "counteraction", sym: "C", name: "Beginning counteraction", act: "complication", gloss: "The hero agrees to act.",
      realize: ["%connect% %hero% said, right gladly, I shall go — and meant it more than was wise.", "%connect% the hero took the quest upon the hero's own neck: to win back %object%, to bring home %heroine%."] },
    { id: "departure", sym: "↑", name: "Departure", act: "journey", gloss: "The hero leaves home.",
      realize: ["%connect% %hero% set out from %place% with little but a name and a need, and the road took the rest.", "%connect% the hero rode out toward %place2%, and the hall watched the dust until there was no dust."] },
    { id: "donor", sym: "D", name: "The donor's test", act: "journey", gloss: "The hero is tested by a donor.",
      realize: ["%connect% on the road stood %donor%, who set the hero a small strange test before any gift was named.", "%connect% %donor% asked of %hero% a courtesy, or a cruelty refused, or a riddle — the toll the road takes."],
      invert: ["%connect% the donor failed the *hero's* test, fumbled the riddle, and had to be tutored in donoring before the gift could change hands."] },
    { id: "reaction", sym: "E", name: "Hero's reaction", act: "journey", gloss: "The hero responds to the donor.",
      realize: ["%connect% %hero% answered as one ought — spared the small beast, shared the last bread, kept the hard word — and so passed.", "%connect% the hero did the kind thing without weighing it, which is the only way the test is ever passed."] },
    { id: "receipt", sym: "F", name: "Receipt of the magical agent", act: "journey", gloss: "The hero acquires the magical agent.",
      realize: ["%connect% the gift was given into the hero's hand: %object2%, which would matter exactly once and exactly enough.", "%connect% %donor% gave up %object2% — guard it, the donor said, and use it but the once."],
      invert: ["%connect% the magical agent turned out to be %object2%, which is the single most useless object in any of the long reels, and the hero was stuck with it."] },
    { id: "guidance", sym: "G", name: "Guidance", act: "journey", gloss: "The hero is led to the object of the search.",
      realize: ["%connect% %helper% brought the hero the long way to %place2%, where the trouble kept its house.", "%connect% the road folded, the way roads fold in tales, and %hero% stood at the threshold of %place2% before the hero was ready."] },
    { id: "struggle", sym: "H", name: "Struggle", act: "ordeal", gloss: "Hero and villain join in direct combat.",
      realize: ["%connect% %hero% and %villain% met at the ford, and there were no more words to spend.", "%connect% %hero% closed with %creature% in %place2%, and the world narrowed to the reach of an arm."] },
    { id: "branding", sym: "I", name: "Branding", act: "ordeal", gloss: "The hero is marked.",
      realize: ["%connect% the hero took a mark in it — a nick at the throat, a ring on the hand, a scar that told the rest of the story for the hero ever after.", "%connect% %hero% came away marked, and the mark was the true coin of the deed."],
      invert: ["%connect% the hero asked, very reasonably, *not* to be branded this time, and for once the tale allowed it, and everyone felt the lack of a scar."] },
    { id: "victory", sym: "J", name: "Victory", act: "ordeal", gloss: "The villain is defeated.",
      realize: ["%connect% with %object2% and the one blow it was good for, %hero% had the better of %villain%.", "%connect% the creature went down, or yielded its pledge, and the long fear of %place% was over."] },
    { id: "liquidation", sym: "K", name: "Liquidation of lack", act: "ordeal", gloss: "The initial lack is set right.",
      realize: ["%connect% %heroine% was won back, %object% restored, the hunger of the kingdom fed at last.", "%connect% the lack that had walked the land lay down: water in the well, an heir in the hall, the thing made whole."] },
    { id: "return", sym: "↓", name: "Return", act: "homecoming", gloss: "The hero sets out for home.",
      realize: ["%connect% %hero% turned the horse toward %place% and the long road home, which is never the same road.", "%connect% homeward, then — and home is the harder country, as every returning hero learns."] },
    { id: "pursuit", sym: "Pr", name: "Pursuit", act: "homecoming", gloss: "The hero is pursued.",
      realize: ["%connect% behind the hero came %villain%'s kin on the wind, and the chase was on across %place2%.", "%connect% the dark sent something after %hero% — a screaming on the road, a shape that gained."],
      invert: ["%connect% nobody pursued the hero at all; the road home was insultingly quiet; the hero kept looking over a shoulder at nothing, which Mercury insists is funnier."] },
    { id: "rescue", sym: "Rs", name: "Rescue", act: "homecoming", gloss: "The hero is rescued from pursuit.",
      realize: ["%connect% %helper% threw the comb that became a forest, the cloth that became a flood, and the chase fell behind.", "%connect% %object2% saved the hero the second time, as gifts in tales are good for twice when they are good at all."] },
    { id: "unfounded-claims", sym: "L", name: "Unfounded claims", act: "homecoming", gloss: "A false hero claims the hero's prize.",
      realize: ["%connect% while the true %hero% was on the road, %false% came to %place% with the head, the heart, the token, and the lie that he had done it.", "%connect% %false% stood in the hall and claimed the bride and the praise, having done nothing but arrive first."] },
    { id: "difficult-task", sym: "M", name: "Difficult task", act: "recognition", gloss: "A difficult task is set.",
      realize: ["%connect% to sort true from false a task was set: lift the stone, string the bow, name the thing none could name.", "%connect% %elder% set the proof — only the hand that did the deed can do this thing — and the hall held its breath."] },
    { id: "solution", sym: "N", name: "Solution", act: "recognition", gloss: "The task is resolved.",
      realize: ["%connect% %hero% did it at the first asking, easily, the way only the true hand can.", "%connect% the bow was strung, the stone was lifted, the name was said, and the false claim went grey in the air."] },
    { id: "recognition", sym: "Q", name: "Recognition", act: "recognition", gloss: "The hero is recognised.",
      realize: ["%connect% then they knew the hero — by the mark, by the token, by the very face of the father in the son.", "%connect% %helper% cried out: it is the hero, it was the hero all along, look."] },
    { id: "exposure", sym: "Ex", name: "Exposure", act: "recognition", gloss: "The false hero is exposed.",
      realize: ["%connect% %false%'s lie came apart in three sentences, as such lies do once the true hand is in the room.", "%connect% the false hero could not do the task, and that was the whole of the exposure."],
      invert: ["%connect% the false hero, exposed, simply explained the lie so charmingly that the court took *his* side, and the true hero had to apologise for the awkwardness."] },
    { id: "transfiguration", sym: "T", name: "Transfiguration", act: "recognition", gloss: "The hero is given a new appearance.",
      realize: ["%connect% the hero was made new — the rags fell, the true name was spoken, and a king stood where a beggar had stood.", "%connect% %hero% put off the old shape and the old name and took up the better ones, earned now."] },
    { id: "punishment", sym: "U", name: "Punishment", act: "recognition", gloss: "The villain is punished.",
      realize: ["%connect% %villain% paid — by the law, by the blade, or by the long shame, as the tale's country preferred.", "%connect% the wrong-doer got the wage of the wrong, and the hall was glad of it."],
      invert: ["%connect% the villain was not punished at all — was, if anything, given a small pension — for in this country they had read enough endings to find vengeance tedious."] },
    { id: "wedding", sym: "W", name: "Wedding", act: "recognition", gloss: "The hero is married and ascends the throne.",
      realize: ["%connect% %hero% wed %heroine%, and %place% kept the feast until the lamps burned low.", "%connect% there was a wedding, and a crowning, and the line went on — which is how the old reels like to close a door."] }
  ];
  ...
  var MOTIFS = [
    { code: "A1654", cls: "A", name: "Origin of a custom / game first played", gloss: "The tale ends by naming a real-world thing it claims to have founded — a game, a lay, a livery.", realize: "and that, they say, was the first time ever the thing was done, and it is done so yet.", cross: ["A1450"] },
    { code: "A186", cls: "A", name: "A demoted god walks as a character", gloss: "An old divinity, euhemerised, moves through the tale as a mortal king or bride.", realize: "%creature% was older than any god the tale would name, and walked as a %honorific% notwithstanding.", cross: ["F232"] },
    { code: "B211", cls: "B", name: "Speaking animal", gloss: "A beast counsels, warns, or bargains in human speech.", realize: "and %creature% spoke then, in the plain tongue of the hall, which surprised no one in a tale of that country." },
    { code: "B313", cls: "B", name: "Helpful animal, a gift repaid", gloss: "A beast spared early returns at need to repay the kindness.", realize: "the small beast the hero had spared on the road came back at the worst hour, debt in its mouth." },
    { code: "D1361.5", cls: "D", name: "Transformation by another's borrowed form", gloss: "One figure wears another's shape so wholly that no one near suspects.", realize: "%villain% laid its own form on %hero% for a term, so that not a soul in %place% knew the change.", cross: ["K1810"] },
    { code: "D1652", cls: "D", name: "The inexhaustible (or unfillable) vessel", gloss: "A container that never empties — or, inverted, never fills.", realize: "%object% would not be filled, however they fed it; the more it took, the emptier it stayed.", cross: ["D1472"] },
    { code: "D1810.8", cls: "D", name: "Magic knowledge / a warning in a dream", gloss: "Foreknowledge arrives in sleep, by oracle, or by a counselling token.", realize: "in sleep the warning came to %hero%, plain and unwelcome, the way true warnings come." },
    { code: "F302", cls: "F", name: "The fairy mistress / Otherworld bride", gloss: "A woman of the Otherworld loves a mortal and crosses over to him.", realize: "%heroine% had loved %hero% before ever they met, and had crossed out of %place2% to find him.", cross: ["F302.1.2"] },
    { code: "F320", cls: "F", name: "Fairies carry mortals off", gloss: "The Otherworld reaches across a threshold-hour and takes a person away.", realize: "the unseen power took %heroine% across the threshold at the thin hour, and left no print to follow." },
    { code: "F167", cls: "F", name: "The shining beast of the Otherworld", gloss: "An animal of unearthly colour marks the border of the other realm.", realize: "%creature% came out of %place2%, of a colour no waking beast wears, and that was the first sign." },
    { code: "F771", cls: "F", name: "The Otherworld hall", gloss: "A court of the other realm — finer, or stranger, than any in the world.", realize: "%place2% opened into a hall finer than any %honorific%'s, with no door the hero had seen them pass." },
    { code: "F576", cls: "F", name: "Otherworldly speed / cannot be overtaken", gloss: "A figure moves at a pace no pursuit can match; only asking will halt it.", realize: "the faster they rode after %heroine%, the further she drew; only the right word, gently asked, would halt her." },
    { code: "G512", cls: "G", name: "The ogre / monster slain", gloss: "A giant, worm, or demon holding the land in fear is put down.", realize: "%creature% had held %place2% in fear past living memory, and now it would not." },
    { code: "G530", cls: "G", name: "The ogre's helpful kin", gloss: "A daughter, wife, or servant of the monster helps the hero against it.", realize: "%helper%, of the monster's own household, turned and showed %hero% the one way in." },
    { code: "H1556", cls: "H", name: "Test of fidelity", gloss: "Faithfulness is tried — in a bed, in a bargain, in a long absence.", realize: "for a whole term %hero% was tried in faith, and turned away nightly, and said no word of it.", cross: ["T338"] },
    { code: "H335", cls: "H", name: "Tasks set for the suitor", gloss: "A bride's keeper sets impossible labours before the wedding.", realize: "%elder% set %hero% a string of impossible labours for %heroine%'s hand, meaning each to be the last." },
    { code: "H561", cls: "H", name: "The riddle solved", gloss: "A clever answer turns a trap, a sphinx, or a doom aside.", realize: "the riddle had killed the others; %hero% turned it over once and gave it back its own answer." },
    { code: "J1115", cls: "J", name: "The clever one outwits the strong", gloss: "Wit beats force; the small or weak undoes the great.", realize: "%hero% had no strength to match %villain%, and so used the better tool, which is the head." },
    { code: "K1810", cls: "K", name: "Deception by disguise", gloss: "The hero or villain passes hidden in borrowed or beggar's clothing.", realize: "%hero% came into %place% in beggar's rags at the hour of most wine and least suspicion.", cross: ["K1812", "D1361.5"] },
    { code: "K500", cls: "K", name: "Death escaped by a trick of words", gloss: "A clause, a quibble, or a legal nicety turns the killing aside.", realize: "it is no fit death, %villain% pleaded — to be killed so — and on that nicety was let go under pledge." },
    { code: "K2110", cls: "K", name: "The slander of the innocent", gloss: "Coordinated false witness destroys a blameless figure.", realize: "%false% and the others had their story straight: six mouths against one, and the one could not be heard." },
    { code: "K1610", cls: "K", name: "The deceiver falls into his own trap", gloss: "The trickster is undone by the very snare he laid.", realize: "the snare %villain% set caught %villain%, by the foot, and the hall laughed before it judged." },
    { code: "M223", cls: "M", name: "The rash promise / the blank boon", gloss: "A boon is granted before it is named, and the naming binds.", realize: "%hero% granted the boon unasked-what, and %villain% named it after — the bride, the hall, the half of all.", cross: ["M201"] },
    { code: "M201", cls: "M", name: "The pledge held on honour", gloss: "A sworn word is kept though it costs more than it is worth.", realize: "the word once given was a chain, and %hero% wore it though it galled, because a word is a deed not yet done." },
    { code: "M242", cls: "M", name: "The year-and-a-day bargain", gloss: "A meeting, a debt, or a doom is set at a fixed future term.", realize: "%term% from that night, they swore, at this same place — and time keeps such appointments whether men will or no." },
    { code: "N777", cls: "N", name: "The hunt that leads to the adventure", gloss: "A chase after beast or bird carries the hero across the threshold of the tale.", realize: "it was a hunt that began it — a beast that ran wrong, into %place2%, and %hero% after it alone." },
    { code: "N886", cls: "N", name: "Recognition by resemblance", gloss: "A face, a likeness to the father, betrays the hidden hero.", realize: "%helper% looked at the child and saw the father's face on it, and the truth fell out of the looking." },
    { code: "Q40", cls: "Q", name: "The reward refused", gloss: "The doer of the great deed takes none of the offered pay.", realize: "offered the best of %place% for it, %hero% would take nothing; the deed, the hero said, was the wage." },
    { code: "Q450", cls: "Q", name: "The cruel punishment — or its pointed absence", gloss: "The villain is broken on the wheel of the ending; or, tellingly, is not.", realize: "and here the country's grammar showed: the wrong was paid in full coin, or not paid at all, and the not-paying said the more." },
    { code: "R11", cls: "R", name: "The carrying-off", gloss: "Maiden, child, or treasure is abducted into the far place.", realize: "%villain% bore %heroine% off to %place2%, past the last road, where rescue would have to come on foot." },
    { code: "R215", cls: "R", name: "The flight and the obstacle-cast", gloss: "Fugitives throw down objects that become forest, flood, and fire behind them.", realize: "behind them %helper% cast the comb and the cloth, and a forest stood up, and a river ran, between them and the chase." },
    { code: "S11", cls: "S", name: "The cruel parent / kin", gloss: "A father, stepmother, or uncle works the harm from inside the family.", realize: "the harm wore a kinsman's face — %villain%, of the hero's own blood, which is the worst door for harm to come in by." },
    { code: "S268", cls: "S", name: "The child promised away", gloss: "An heir is pledged, unknowing, to a power that comes to collect.", realize: "%elder% had promised the first thing to meet him home, not knowing it would be %heroine%, and the debt came due." },
    { code: "T11", cls: "T", name: "Love before the meeting", gloss: "The hero loves at a name, a portrait, a rumour — before ever a meeting.", realize: "%hero% loved %heroine% at the bare report of her, and would have no other, having seen none." },
    { code: "T338", cls: "T", name: "The chaste temptation refused", gloss: "Tempted with licence and no witness, the hero keeps faith anyway.", realize: "the night, the leave, and no eye to see — and still %hero% turned to the wall and kept the bond.", cross: ["H1556"] },
    { code: "T211", cls: "T", name: "Faith kept against the false charge", gloss: "A spouse refuses to set the slandered partner aside.", realize: "children there are to her, %hero% said, and I will not put her away — against the whole hall's verdict." },
    { code: "Z65", cls: "Z", name: "Colour-grammar of the Otherworld", gloss: "A fixed palette — white-and-red, or green, or snow — marks the other realm.", realize: "all that came out of %place2% wore the one colour, white-and-red (or green, or snow), so you knew it for what it was." },
    { code: "Z71.1", cls: "Z", name: "The formulistic three", gloss: "Three days, three tasks, three blows: the tale counts in threes.", realize: "three days she rode past, three tasks were set, three blows were struck — for the tale could not count otherwise." },
    { code: "Z71.6", cls: "Z", name: "The year and a day, as the pulse of plot", gloss: "The year-and-a-day measure beats out the structure of the whole.", realize: "%term% to bind it, %term% to suffer it, %term% to mend it: the tale ran on that one measure like a heart." }
  ];
  ...
  var FILL = {
    term: ["a year and a day", "a year from that night", "seven years", "thrice three nights", "a twelvemonth", "the turning of one whole year"],
    number: ["three", "seven", "nine", "twelve", "a hundred"],
    quest: ["the lost crown", "the water that would not come", "the stolen light", "the name no one would say", "the heir taken in the night", "the bride past the last door"],
    // absurd objects the remixer swaps in "for laughs" — tagged so the spec can flag the joke
    absurdObject: ["a magic spoon that stirred only widdershins", "an enchanted ledger that balanced itself and gloated", "a self-important teapot", "a sock that granted one wish, badly", "a turnip of prophecy", "a very small and bureaucratic door", "a cheese that remembered everything", "an umbrella that worked only indoors"],
    absurdCreature: ["a dragon that hoarded overdue library books", "a sphinx that had run out of riddles and now just sighed at you", "a giant exclusively afraid of teaspoons", "a were-accountant", "a ghost who haunted the wrong house out of politeness", "a sea-serpent on a strict diet of rumours"],
    connectorTime: ["that winter", "by midsummer", "before the snow", "at the thin of the year", "on the eve of the feast", "when the moon was old"]
  };
