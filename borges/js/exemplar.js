/* borges — THE EXEMPLAR. The hand-authored gold-standard telling of tale № 1:
   the canonical first page of the Book of Sand, and the quality target the live
   render aims at. It is a faithful retelling of the deterministic spec for n = 1
   (Luna; The Slaying at the Water; Finnic furniture grafted with Slavic; the cast
   Yemelya / Ilmatar / Lemminkäinen / Väinämöinen / Vasily / Ilmarinen / Koschei;
   the duel of shapes, the ball of yarn spent but once, the raising of the mound,
   the stolen boast, the comic confession). Two uses: a few-shot reference in the
   prompt (for finish, not content), and the pre-seeded telling served for /t/1.
   Attaches to BORGES.exemplar. */
(function () {
  "use strict";
