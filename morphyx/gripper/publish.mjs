...
const RETIRED = { v1: ['base', 'bracket', 'end-block', 'rail-block', 'saddle', 'coupler', 'motor-shaft', 'nut-bracket'], v2: ['slider'], v3: ['yoke'], v4: ['tab', 'pad', 'rod', 'crossbar'], v5: ['bed', 'slide', 'finger'], v6: ['spacer'], v8: ['rear-flange'], v9: ['bulkhead', 'side-wall', 'floor', 'lid'], v10: ['collar'] };
...
if (drive && await drive.find('gripper/stroke')) { await drive.rename('gripper/stroke', 'gripper/v9/stroke'); console.log('  moved  gripper/stroke → gripper/v9/stroke'); }
else if (!drive) console.log('  plan  gripper/stroke → gripper/v9/stroke (if present)');
if (drive) {
