...
const RETIRED = { v1: ['base', 'bracket', 'end-block', 'rail-block', 'saddle', 'coupler', 'motor-shaft', 'nut-bracket'], v2: ['slider'], v3: ['yoke'], v4: ['tab', 'pad', 'rod', 'crossbar'], v5: ['bed', 'slide', 'finger'] };
