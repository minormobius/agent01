#!/usr/bin/env node
// build-office.mjs — extract the site catalogue (catalogue.json) into
// office/surfaces.json, the data that drives the
...
// desks. catalogue.json is already the curated taxonomy
...
// --- The taxonomy ------------------------------------------------------------
// Read catalogue.json, the source of truth. This used to bracket-walk index.html
// and eval the `var P` literal back out of the page; catalogue.json is that same
// list, as data, so no parsing is involved.
...
const out = {
  $comment: 'GENERATED by scripts/build-office.mjs from catalogue.json. Do not hand-edit — edit catalogue.json and re-run `node scripts/build-office.mjs --write`.',
