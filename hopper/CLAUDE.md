...
| `js/{prng,genome,crystal,prism,stack,ico,worms,render,tilings}.js` | **synced copies** of `packages/bismuth/` — never edit here; `scripts/sync-dataviz.mjs --check` fails the deploy if they drift |
