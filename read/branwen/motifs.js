...
window.BRANWEN.motifs = {
  ...
  list: [
    ...
    { cls: "F", code: "F407", name: "The living / talking severed head", conf: "high", passages: [6],
    ...
    // — Z · Formulas & refrains —
    { cls: "Z", code: "Z71.16", name: "The refrain of the two ruined islands", conf: "med", passages: [6],
