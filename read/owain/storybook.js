...
window.OWAIN.book = {
  ...
  spreads: [
    ...
    { title: "Arthur Finds Owain Again",
      text: "Back home, King Arthur missed Owain so much that he and all his knights rode out to find him. At the fountain they raised the storm — and a knight in dark armour unhorsed them one after another, for none of them knew it was Owain himself. Only his cousin Gwalchmei could stand against him, and the two fought for three whole days, neither able to win. At last a blow knocked the helmet from Gwalchmei's face. “Cousin!” cried Owain. “I did not know you!” Then Arthur came running, and the whole company crowded round to hug Owain, so glad to see him that they nearly knocked one another over.",
      illus: "A joyful reunion in a green valley near the great tree and the stone-rimmed fountain. King Arthur (mature, gold circlet, deep-red mantle over mail) and the knight Gwalchmei (fair, green-and-gold surcoat) embracing Owain (dark hair, deep-blue surcoat over mail) in the centre; a great crowd of armoured Welsh knights pressing round them, smiling and reaching to embrace him. Warm, painterly, earthy palette with gold accents, child-friendly, pure happiness." },

    { title: "The Wild Man and the Healing Balsam",
      text: "But Owain stayed too long at Arthur's court, and forgot the promise he had made his wife. One day a maiden rode in and took the magic ring from his finger. Owain remembered everything, and was so ashamed and sorrowful that he wandered away into the wild mountains. His fine clothes fell to rags; he grew thin and ragged, and lived among the deer, until one day he wandered, half-asleep, into the fairest park in the world. There a kind widowed countess found him by her lake, worn to skin and bone. She had her maid gently rub him all over with a precious healing balsam, and leave fresh clothes and a horse beside him. Little by little Owain stirred, and rose, and became himself once more.",
      illus: "Owain in his madness — gaunt, ragged and barefoot, hair and beard wild and matted, the tatters of fine cloth on him — lying half-waking on the grass by a still lake in a beautiful green park at dawn. A kind, richly-dressed widowed noblewoman (auburn-haired, in a deep-green gown) and her young maid nearby; the maid kneeling, gently anointing him from a small flask of balsam; a fine horse and a folded bundle of clean clothes set on the grass beside him. Tender, hopeful, painterly, earthy palette with soft morning light, handled with folktale gentleness, child-friendly." },
  ],
};
