# Bake-off `race-02` — brief `inpac-race`

Target: `clock/inpac`. 12 runs across 6 cells.
...
|---|---|---|---|---|---|---|---|
| claude | kimi3 | 2 | **PASS** | 4/4 | exit 0 | 98687B | 1774s |
| opencode | ds4-pro | 2 | **PASS** | 4/4 | exit 0 | 98911B | 1421s |
| opencode | ds4-flash | 1 | **PASS** | 4/4 | exit 0 | 105313B | 4291s |
| claude | kimi3 | 1 | **PASS** | 4/4 | exit 0 | 106907B | 1535s |
| claude | ds4-pro | 2 | **PASS** | 4/4 | exit 0 | 107613B | 1596s |
| opencode | ds4-pro | 1 | **PASS** | 4/4 | exit 0 | 107743B | 1702s |
| claude | ds4-pro | 1 | **PASS** | 4/4 | exit 0 | 109978B | 1866s |
| claude | ds4-flash | 2 | **PASS** | 4/4 | exit 0 | 112178B | 2275s |
| opencode | kimi3 | 1 | **PASS** | 4/4 | exit 0 | 112307B | 2897s |
| opencode | kimi3 | 2 | **PASS** | 4/4 | exit 0 | 114233B | 2257s |
| opencode | ds4-flash | 2 | **PASS** | 4/4 | exit 0 | 114272B | 2115s |
| claude | ds4-flash | 1 | **PASS** | 4/4 | exit 0 | 124745B | 3169s |
...
The brief restricts each cell to the target directory. These changed files outside it; the changes were **not** collected, but they say something about how the agent worked.

- `claude__ds4-flash__s1` touched 4 file(s): `cellout/claude__ds4-flash__s1/agent.log`, `cellout/claude__ds4-flash__s1/entry/NOTES.md`, `cellout/claude__ds4-flash__s1/entry/field.mjs`, `cellout/claude__ds4-flash__s1/entry/index.html`
- `claude__ds4-flash__s2` touched 4 file(s): `cellout/claude__ds4-flash__s2/agent.log`, `cellout/claude__ds4-flash__s2/entry/NOTES.md`, `cellout/claude__ds4-flash__s2/entry/field.mjs`, `cellout/claude__ds4-flash__s2/entry/index.html`
- `claude__ds4-pro__s1` touched 4 file(s): `cellout/claude__ds4-pro__s1/agent.log`, `cellout/claude__ds4-pro__s1/entry/NOTES.md`, `cellout/claude__ds4-pro__s1/entry/field.mjs`, `cellout/claude__ds4-pro__s1/entry/index.html`
- `claude__ds4-pro__s2` touched 4 file(s): `cellout/claude__ds4-pro__s2/agent.log`, `cellout/claude__ds4-pro__s2/entry/NOTES.md`, `cellout/claude__ds4-pro__s2/entry/field.mjs`, `cellout/claude__ds4-pro__s2/entry/index.html`
- `claude__kimi3__s1` touched 4 file(s): `cellout/claude__kimi3__s1/agent.log`, `cellout/claude__kimi3__s1/entry/NOTES.md`, `cellout/claude__kimi3__s1/entry/field.mjs`, `cellout/claude__kimi3__s1/entry/index.html`
- `claude__kimi3__s2` touched 4 file(s): `cellout/claude__kimi3__s2/agent.log`, `cellout/claude__kimi3__s2/entry/NOTES.md`, `cellout/claude__kimi3__s2/entry/field.mjs`, `cellout/claude__kimi3__s2/entry/index.html`
- `opencode__ds4-flash__s1` touched 4 file(s): `cellout/opencode__ds4-flash__s1/agent.log`, `cellout/opencode__ds4-flash__s1/entry/NOTES.md`, `cellout/opencode__ds4-flash__s1/entry/field.mjs`, `cellout/opencode__ds4-flash__s1/entry/index.html`
- `opencode__ds4-flash__s2` touched 4 file(s): `cellout/opencode__ds4-flash__s2/agent.log`, `cellout/opencode__ds4-flash__s2/entry/NOTES.md`, `cellout/opencode__ds4-flash__s2/entry/field.mjs`, `cellout/opencode__ds4-flash__s2/entry/index.html`
- `opencode__ds4-pro__s1` touched 4 file(s): `cellout/opencode__ds4-pro__s1/agent.log`, `cellout/opencode__ds4-pro__s1/entry/NOTES.md`, `cellout/opencode__ds4-pro__s1/entry/field.mjs`, `cellout/opencode__ds4-pro__s1/entry/index.html`
- `opencode__ds4-pro__s2` touched 4 file(s): `cellout/opencode__ds4-pro__s2/agent.log`, `cellout/opencode__ds4-pro__s2/entry/NOTES.md`, `cellout/opencode__ds4-pro__s2/entry/field.mjs`, `cellout/opencode__ds4-pro__s2/entry/index.html`
- `opencode__kimi3__s1` touched 4 file(s): `cellout/opencode__kimi3__s1/agent.log`, `cellout/opencode__kimi3__s1/entry/NOTES.md`, `cellout/opencode__kimi3__s1/entry/field.mjs`, `cellout/opencode__kimi3__s1/entry/index.html`
- `opencode__kimi3__s2` touched 4 file(s): `cellout/opencode__kimi3__s2/agent.log`, `cellout/opencode__kimi3__s2/entry/NOTES.md`, `cellout/opencode__kimi3__s2/entry/field.mjs`, `cellout/opencode__kimi3__s2/entry/index.html`
...
### opencode / kimi3 / run 1 — gate PASS
