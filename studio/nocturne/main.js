// main.js — Nocturne: the page. The score is the clock; every note is a window.
//
...
mountExtras({
  slug: 'nocturne', title, subtitle: 'a city, lit one window per note',
  events, seconds: duration, makeRenderer, piano, ink: '#f1ead8', onInk: '#171a33',
});
