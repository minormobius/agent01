// ┌───────────────────────────────────────────────────────────────────────────┐
// │ VENDORED — verbatim copy of read/alch/correspondences.js.                   │
// │                                                                             │
// │ hoop is a no-build static site and cannot import a sibling surface at       │
// │ runtime, so the Alchemist's Garden correspondence data is copied here whole │
// │ (same rule as vendor/auth.js and forge/vendor/biome/*: COPY, NEVER FORK).   │
// │ It is the scholarly source of truth for the alchemy vertical — 55 herbs,    │
// │ each with a planet (one of the Seven), a Galenic temperament, Macer's       │
// │ degree, and the planet→metal bridge. alch/alchemy.js turns this into the    │
// │ combat/social/lubricant effect grammar hoopy's content authors against.     │
// │                                                                             │
// │ RE-SYNC when read/alch/correspondences.js changes:                          │
// │     cp read/alch/correspondences.js hoop/v105/alch/correspondences.js       │
// │   then restore this banner. Do NOT edit the data here — edit it in read/    │
// │   and re-copy, so the scholarly edition stays the single origin.            │
// └───────────────────────────────────────────────────────────────────────────┘
// ─────────────────────────────────────────────────────────────────────────────
