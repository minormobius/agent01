# hoop/v099/morph/ — vendored morph engine (verbatim) · PROTOTYPE
...
Same rule as `hoop/vendor/auth.js` and `hoop/v099/forge/`: **re-sync, never
...
## Status: DEFAULT (v099) — morph is the live arcade engine
