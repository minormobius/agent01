...
//   node hoop/v104/test/solvable.selftest.mjs
//
// Two halves:
...
// ── 2c. DIALOGUE REACHABILITY (v104): a set_facts parked where play can't reach is NOT a setter ──
...
// ── 2d. waivableGates (v104): the runtime waiver's shopping list ──
