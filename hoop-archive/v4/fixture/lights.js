...
// ── VENDORED into hoop/v4 from mega/sprite/fixture/lights.js. hoop is a no-build static site and can't
// import a sibling site at runtime, so this is a copy — re-sync from source, don't fork (vendor/auth.js
// rule). Only the voronoi import is repointed at hoop's existing paint/voronoi.js (shared source). ──
import { bucketGrid } from '../../paint/voronoi.js';   // ray-trace through the SAME tiling the chamber paints
