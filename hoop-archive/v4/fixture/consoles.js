...
// ── VENDORED into hoop/v4 from mega/sprite/fixture/consoles.js — re-sync from source, don't fork
// (vendor/auth.js rule). Only the voronoi import is repointed at hoop's existing paint/voronoi.js. ──
import { bucketGrid } from '../../paint/voronoi.js';   // to find the nearest wall by marching from the seed
