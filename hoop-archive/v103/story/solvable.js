...
//   • the gate's setting choice is REACHABLE inside the setter's dialogue (v103): walking from `start`
...
// to embiggen is guaranteed by flagKeeperResident's low-vitality fallback — and (v103, the Miren
...
export function proveProgression(content, opts = {}) {
  ...
  for (const a of chain) {
    ...
    for (const g of a.gates) {
      ...
      // the flag-setting choice must be REACHABLE inside the setter's own dialogue (v103): from `start`,
